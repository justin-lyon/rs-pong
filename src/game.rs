...
impl Game {
  pub fn new(width: i32, height: i32) -> Self {
    Self {
      ...
      ball: Ball::new(6.0, MARGIN_TOP + 4.0, 100.00, 0.0),
  ...
  pub fn update_ball(&mut self, delta_time: f64) {
    ...
    if next_x > self.width as f64 || next_x < 0.0 {
      ...
      if next_x > self.player.get_position_x() + 1_f64 {
        ...
        self.ball.set_velocity(100.00, 0.0);
        self
          .ball
          .set_position(6.0, 6.0 + MARGIN_TOP);
        self.score += 1;
      }
    }
  ...
  fn update_ai(&mut self, delta_time: f64) {
    ...
    if self.ball.get_velocity_x() < 0.0 {
      if next_y < self.enemy.get_position_y() {
        ...
        > self.enemy.get_position_y() + self.enemy.get_size() as f64
      {
  ...
  fn restart(&mut self) {
    ...
    self
      .ball
      .set_position(6.0, (self.height / 2) as f64);
